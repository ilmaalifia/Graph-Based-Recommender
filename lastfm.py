...
store_file = 'D:/OneDrive - Institut Teknologi Bandung/Tugas Akhir/Kode/Last.FM Preprocessed/'
results_folder = 'D:/OneDrive - Institut Teknologi Bandung/Tugas Akhir/Kode/Output/Last.FM/10_1000/'
...
popular_article_list = np.load(store_file + 'lastfm_popular_item.npy', allow_pickle = True)
